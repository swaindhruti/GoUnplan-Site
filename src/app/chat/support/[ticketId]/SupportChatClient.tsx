...
import { getTicketById, addTicketMessage, updateTicket } from '@/actions/support/actions';
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <span className="text-gray-600 font-instrument">Loading ticket...</span>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-6">
          ...
          <h1 className="text-2xl font-bold mb-4 font-bricolage">Ticket Not Found</h1>
          <p className="text-gray-600 font-instrument mb-6">
            The support ticket you&apos;re looking for doesn&apos;t exist or you don&apos;t have
            access to it.
          </p>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <h1 className="text-2xl font-bold font-bricolage text-gray-900">{ticket.title}</h1>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white/80 backdrop-blur-sm border border-slate-200/60 rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Badge variant="outline" className="font-instrument border-slate-200">
                    {ticket.category}
                  </Badge>
                </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm border border-slate-200/60 rounded-2xl shadow-lg p-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold font-instrument text-gray-900">{ticket.user.name}</p>
                  <p className="text-sm text-gray-600 font-instrument">{ticket.user.email}</p>
                </div>
              </div>
            </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm border border-slate-200/60 rounded-2xl shadow-lg p-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 font-instrument">{ticket.assignee.email}</p>
                  </div>
                </div>
              </div>
            )}
