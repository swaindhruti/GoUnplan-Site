...
export const HowItWorksSection = () => {
  return (
    <div className="relative min-h-screen mt-20 flex items-stretch">
      <div className="grid grid-cols-1 lg:grid-cols-2 w-full h-screen">
        <div className="flex items-center justify-center bg-purple-500 px-6 py-16 lg:py-0">
          <div className="max-w-lg w-full text-center lg:text-left">
            <span className="inline-block px-3 py-1.5 sm:px-4 sm:py-2 bg-white/20 rounded-full text-white text-xs sm:text-sm font-bold mb-6 border border-white/30 drop-shadow-lg">
              HOW IT WORKS
            </span>
