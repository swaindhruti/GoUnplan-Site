      ...
      <div className="flex flex-col lg:flex-row items-center justify-center max-w-6xl w-full gap-10">
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          ...
          <p className="text-base md:text-lg font-instrument text-gray-700 leading-relaxed mt-6">
            We started this because we were tired of cookie-cutter trips. Here, travel isn’t about
            packages, it’s about people. A host who shares their world. A traveler who finds their
            tribe. And stories that stay long after the trip ends.
