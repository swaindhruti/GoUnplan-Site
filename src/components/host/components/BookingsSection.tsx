...
export const BookingsSection = () => {
  ...
  const fetchBookings = useCallback(async () => {
    ...
    try {
      const response = await getHostBookings(selectedStatus, selectedTrip || undefined, 'payment');
    ...
    return (
      <div className="space-y-8">
        <div>
          ...
          <p className="text-gray-600 font-medium">Manage and track all your trip bookings</p>
        </div>
  ...
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-3xl font-bold text-gray-900 mb-2">Bookings</h2>
        <p className="text-gray-600 font-medium">Select a trip to view and manage its bookings</p>
      </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">View all upcoming confirmed bookings</p>
            </div>
          </div>
          <button
        ...
        {showUpcoming && upcomingTrips.length > 0 && (
          <div className="mt-6 space-y-3">
            {upcomingTrips.map(booking => (
              <div key={booking.id} className="bg-white rounded-lg border border-purple-200 p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="font-semibold text-gray-900">{booking.travelPlan.title}</h4>
                    <p className="text-sm text-gray-600">
                      {formatDate(booking.startDate)} • {booking.participants} guests •{' '}
                      {booking.user.name}
                    </p>
                  </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <h3 className="text-xl font-semibold text-gray-900 mb-4">Active Trips</h3>
        {trips.length === 0 ? (
      ...
      {selectedTrip && (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <h3 className="text-xl font-semibold text-gray-900 mb-4">
            Bookings for {trips.find(t => t.travelPlanId === selectedTrip)?.title}
          </h3>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h4 className="font-semibold text-gray-900 font-mono">{booking.id}</h4>
                          <p className="text-sm text-gray-600">
