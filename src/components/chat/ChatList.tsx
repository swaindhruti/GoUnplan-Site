...
export default function ChatList({ userId, onChatSelect, initialChats = [] }: ChatListProps) {
                ...
                >
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="relative overflow-hidden flex-shrink-0">
                      <Image
                        src={chat.otherUser?.image || '/placeholder.svg?height=48&width=48'}
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <div className="flex items-center space-x-2 flex-shrink-0">
                          <Badge
                            variant={chat.otherUser?.role === 'HOST' ? 'default' : 'secondary'}
                            className="text-xs"
                          >
                            {chat.otherUser?.role}
                          </Badge>
