...
import { Calendar, CheckCircle, Clock, XCircle, AlertTriangle, RefreshCw } from 'lucide-react';
...
export function BookingsTab({ bookings, bookingFilter, setBookingFilter }: BookingsTabProps) {
  ...
  return (
    <>
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-6">
        <div>
          <h3 className="text-2xl font-bold text-gray-900 mb-1 font-bricolage">Your Bookings</h3>
          <p className="text-gray-600 font-instrument mt-1">Manage your travel bookings</p>
        </div>
              ...
              {filteredBookings.map(booking => (
                <TableRow key={booking.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <TableCell className="px-6 py-4 text-gray-600 font-instrument">
                    {[booking.travelPlan.city, booking.travelPlan.state, booking.travelPlan.country]
                      .filter(Boolean)
                      .join(', ')}
                  </TableCell>
                  <TableCell className="px-6 py-4 text-gray-600 font-instrument">
                  ...
                  <TableCell className="px-6 py-4">
                    <div className="space-y-1">
                      ...
                      {booking.paymentStatus === 'PARTIALLY_PAID' && booking.amountPaid && (
                          ...
                          {(booking.paymentStatus === 'PENDING' ||
                            ...
                            booking.paymentDeadline && (
                              <p className="text-xs text-gray-500">
                                Due: {new Date(booking.paymentDeadline).toLocaleDateString()}
                              </p>
                            )}
                        </div>
                      );
          ...
          <div className="flex items-center justify-center py-16">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4 font-bricolage">
                {bookings.length === 0 ? 'No bookings found' : `No ${bookingFilter} bookings found`}
              </h3>
